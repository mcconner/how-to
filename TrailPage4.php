...
<p> Here are two example searches. In each search, the first part of the URL (up to the API key) is the same. Then, we append the parameters to the end of the URL, 
...
<ul>
	...
	<li>limit: to limit the number of search results that appear</li>
</ul>
...
<h4>Example 3: Search for any activities within a 10 mile radius of San Diego, California, using latitude and longitude. [lon(-117.06816) and lat(33.0663) values]</h4>
<p class="output">https://outdoor-data-api.herokuapp.com/api.json?<font color=blue>api_key</font>=<font color=green>APIKey</font>&<font color=blue>lat</font>=<font color=green>33.06634</font>&<font color=blue>lon</font>=<font color=green>-117.06816</font>&<font color=blue>radius</font>=<font color=green>20</font></p>
...
I won't show the results because there are too many.<br><br>
<br>
<ul class="hnavbar">
